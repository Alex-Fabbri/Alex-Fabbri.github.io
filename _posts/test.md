...
Welcome! If you've made it here, you are probably interested in Natural Language Processing \(NLP\) or a related field \(even if you're not, keep reading!\). NLP is rapidly growing, and, as a result, advancing in the field can seem daunting to the student or the researcher. To help the growing NLP community and advance research related to NLP for educational applications, we introduced a new corpus in our paper "[TutorialBank: Using a Manually-Collected Corpus for Prerequisite Chains, Survey Extraction and Resource Recommendation]() by Alexander Fabbri, Irene Li, Prawat Trairatvorakul, Yijiao He, Weitai Ting, Robert Tung, Caitlin Westerfield and Dragomir Radev ([LILY, YALE](https://yale-lily.github.io/)).
...
# check the numbers 
# 6500
# random tutorial of the day
# and or commas in the table A, B and C

# Specify two parts, old one.
...
# change image so that it shows the interface
# for copyright reasons we did not include the documents, just links under "how can I use this for research" 
# thumbs up, thumbs down, 
# emphasize 
# - how can I contribute -- AAN is moderated but if you want to submit a relevant, resource, click here
# link to suggest resource, link 
# report errors
# contribute report, 
# repeated links, github (if you want the sql dump) 
# criterion for inclusiong -- tutorial of general interest (not just an ad for your own paper) 
# readme with bibtex
# json https://jsoneditoronline.org/
# link to about page : http://tangra.cs.yale.edu/newaan/index.php/home/about
# bibtext at the top, or separate about page

# list the different topics, if you want to learn more about LSTM's, MT, 
